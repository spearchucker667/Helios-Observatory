...
/**
 * Workspace root, resolved from this module's location (`<root>/scripts/..`)
 * rather than a hard-coded path, so the same checks run in the Linux sandbox
 * (/workspace) and on a checked-out repo. Callers may still pass an explicit
 * `workspaceRoot` (tests use temp fixtures).
 */
